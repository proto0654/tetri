...
class DemoPushCommand extends Command
{
    ...
    public function handle(DemoContentExporter $exporter): int
    {
        ...
        $user = $this->option('user') ?: env('DEPLOY_USER', 'u1396397');
        $path = $this->option('path') ?: env('DEPLOY_PATH', 'www/tetri.weblaba.ru/');
    ...
    protected function defaultSshKeyPath(): string
    {
        ...
        return $home !== '' ? $home.DIRECTORY_SEPARATOR.'.ssh'.DIRECTORY_SEPARATOR.'weblaba_deploy' : 'weblaba_deploy';
    }
