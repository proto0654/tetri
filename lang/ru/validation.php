...
return [
    ...
    */
    ...
    'any_of' => 'Значение поля :attribute недействительно.',
    'array' => 'Значение поля :attribute должно быть массивом.',
    'array_keys' => 'Значение поля :attribute должно содержать только следующие ключи: :values.',
    'ascii' => 'Значение поля :attribute должно содержать только однобайтовые буквенно-цифровые символы и знаки.',
    'base64' => 'Значение поля :attribute должно быть корректной строкой Base64.',
    ...
    'in_array_keys' => 'Массив в поле :attribute должен содержать хотя бы один из ключей: :values.',
    ...
    'missing_with' => 'Значение поля :attribute должно отсутствовать, если указано :values.',
    ...
    'present_if' => 'Значение поля :attribute должно присутствовать, когда :other содержит :value.',
    'present_unless' => 'Значение поля :attribute должно присутствовать, если только :other не содержит :value.',
    'present_with' => 'Значение поля :attribute должно присутствовать, когда указано :values.',
    'present_with_all' => 'Значение поля :attribute должно присутствовать, когда указаны все :values.',
    ...
    'required_unless' => 'Поле :attribute обязательно, когда :other не содержит :values.',
    ...
    'url' => 'Значение поля :attribute должно быть действительным URL.',
