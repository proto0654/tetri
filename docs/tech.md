...
| Demo URL | REG.RU | `https://tetri.weblaba.ru` |
...
- Public SEO: SiteSettings keys + `documentTitle()`; layout emits meta/og description from settings (home overrides). See [content.md](content.md).
